...
public class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        this.markerColor = attributes.getColor(R.styleable.zxing_finder_zxing_viewfinder_laser,
                resources.getColor(R.color.custom_color_yellow));
    ...
    public void onDraw(Canvas canvas) {
        ...
        // draw mark yellow at corners
        paint.setColor(markerColor);
        // corner top - left
        canvas.drawRect(frame.left - 5 ,frame.top - 5 , frame.left + 35 , frame.top , paint);
        canvas.drawRect(frame.left - 5 ,frame.top   , frame.left , frame.top + 35 , paint);
      
        // corner top - right
        canvas.drawRect(frame.right - 35 ,frame.top - 5 , frame.right + 5 , frame.top  , paint);
        canvas.drawRect(frame.right ,frame.top -5  , frame.right + 5, frame.top + 35 , paint);
        
        // corner bottom - right
        canvas.drawRect(frame.right ,frame.bottom - 35 , frame.right + 5 , frame.bottom +5  , paint);
        canvas.drawRect(frame.right -35,frame.bottom  , frame.right + 5,  frame.bottom +5 , paint);
        
        // corner bottom - left
        canvas.drawRect(frame.left -5 ,frame.bottom - 35 , frame.left  , frame.bottom +5  , paint);
        canvas.drawRect(frame.left -5,frame.bottom  , frame.left + 35,  frame.bottom +5 , paint);
